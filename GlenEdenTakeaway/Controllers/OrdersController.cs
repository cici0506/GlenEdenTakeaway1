...
namespace GlenEdenTakeaway.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(IdentityContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,OrderDate,Quantity,ItemName,Price,CustomerId,EmployeeId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'IdentityContext.Order'  is null.");
            }
            var order = await _context.Order.FindAsync(id);
            if (order != null)
            {
