...
namespace GlenEdenTakeaway.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private GlenEdenTakeawayUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<GlenEdenTakeawayUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(GlenEdenTakeawayUser)}'. " +
                    $"Ensure that '{nameof(GlenEdenTakeawayUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the external login page in /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }

        private IUserEmailStore<GlenEdenTakeawayUser> GetEmailStore()
        {
